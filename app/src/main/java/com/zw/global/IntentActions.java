...
public class IntentActions {
    ...
    public static final String ShowMyMain = "showMyMain";
    public static final String ShowMusicMain = "showMusicMain";
    public static final String ShowTimeMain = "showTimeMain";
    public static final String ShowSettingMain = "showSettingMain";
